...
### 🟢 Artificial Intelligence Engineer — Recruweb
*Full-time · Apr 2026 – Present · 4 mos · Noida, Uttar Pradesh, India · Hybrid*

Building production-grade AI features that power automated recruitment workflows at scale — current role.

**Scope of work:**
- Building production-grade AI features (LLM integration, retrieval pipelines) to power automated recruitment workflows at scale
- Architecting end-to-end GenAI solutions using LangChain and vector databases, reducing manual screening time for the team
...
Built a multimodal GenAI assistant for visually impaired users and deployed a production-style RAG pipeline.

**Scope of work:**
- Built a multimodal GenAI assistant for visually impaired users using LangChain + Gemini 1.5 Pro, achieving 92% scene-classification accuracy on a custom dataset
- Designed and deployed a RAG pipeline (vector DB, chunking, prompt templates) that improved context relevance by 40%, enabling more accurate document Q&A
- Integrated text-to-speech and accessibility flows into an end-to-end demo, leading dataset curation and annotation for 3 iterative model evaluations

`LangChain` `Gemini 1.5 Pro` `RAG` `Computer Vision` `Python`

---

### AI/ML Intern — Antihak AI Cybersecurity Pvt Ltd
*Internship · Feb 2024 – Apr 2024 · 3 mos · Greater Noida · Remote*

Architected an OCR-based transaction monitoring system and improved fraud-detection precision on imbalanced financial datasets.

**Scope of work:**
- Architected "SafeTransact", an OCR-based transaction monitoring system that processed 1,000+ scanned documents with 95% extraction accuracy using Tesseract and Python
- Improved fraud-detection model precision by 18% through advanced feature engineering, model selection, and hyperparameter tuning on imbalanced financial datasets
- Delivered a stakeholder-facing demo and automated evaluation pipeline, enabling smooth handoff to the production team

`OCR` `Tesseract` `Fraud Detection` `Python`

---

### Data Science Intern — Suvidha Foundation
*Internship · Dec 2023 – Feb 2024 · 3 mos · Nagpur, Maharashtra, India · Remote*

Optimized a transformer-based document summarizer and redesigned the preprocessing pipeline for real-time throughput.

**Scope of work:**
- Optimized a transformer-based document summarizer (HuggingFace) that reduced training time by 25% and improved ROUGE score by 15% through long-document chunking strategies
- Increased summarization throughput by 35% by redesigning the preprocessing pipeline, enabling real-time processing of domain-specific documents

`Transformers` `HuggingFace` `NLP` `Python`

---

### ML Trainee — CETPA Infotech Pvt. Ltd.
*Internship · Jun 2022 – Sep 2022 · 4 mos · Remote*

Implemented and evaluated supervised ML algorithms and built reporting pipelines for stakeholders.

**Scope of work:**
- Implemented and evaluated supervised ML algorithms on real datasets, achieving average model accuracy of 87%
- Built data-cleaning pipelines, experiment tracking, and performance reports for stakeholders
- Documented models and metrics to support deployment-ready handoffs

`scikit-learn` `pandas` `Python` `Machine Learning` `Deep Learning`
...
![Google](https://img.shields.io/badge/Transformer_Models_and_BERT-4285F4?style=for-the-badge&logo=google&logoColor=white)
*Issued Feb 2026 · Credential ID 22105302*

**Oracle**

![Oracle](https://img.shields.io/badge/OCI_2025_Certified_Generative_AI_Professional-F80000?style=for-the-badge&logo=oracle&logoColor=white)
*Issued Aug 2025 · Expires Aug 2027*

**Innomatics Research Labs**

![Innomatics](https://img.shields.io/badge/Advanced_ML_%26_Gen_AI-6D28D9?style=for-the-badge&labelColor=1a1a2e)
*Issued Dec 2024 · Credential ID C271220*

![Innomatics](https://img.shields.io/badge/Advanced_Data_Analysis_Internship-7C3AED?style=for-the-badge&labelColor=1a1a2e)
*Issued Sep 2024 · Credential ID C261391*

**GeeksforGeeks**

![GeeksforGeeks](https://img.shields.io/badge/Complete_ML_%26_Data_Science_Program_(6_months)-2F8D46?style=for-the-badge&logo=geeksforgeeks&logoColor=white)
*Issued Jul 2024*

**DeepLearning.AI**

![DeepLearning.AI](https://img.shields.io/badge/Custom_Models,_Layers_%26_Loss_Functions_with_TensorFlow-EB2226?style=for-the-badge&logo=tensorflow&logoColor=white)
*Issued Jun 2024*

**HackerRank**

![HackerRank](https://img.shields.io/badge/Software_Engineer_Intern-2EC866?style=for-the-badge&logo=hackerrank&logoColor=white)
*Issued Jun 2024*

**CETPA Infotech**

![CETPA](https://img.shields.io/badge/Machine_Learning_Using_Python-8B5CF6?style=for-the-badge&labelColor=1a1a2e)
*Issued Jun 2022*
